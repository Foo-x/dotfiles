...
local function toggleterm_config(_, opts)
  ...
  vim.keymap.set('n', '<Plug>(jj)bc', ':<C-u>2TermExecBackground jj bookmark create ')
  ...
  vim.keymap.set('n', '<Plug>(jj)d<CR>', '<Cmd>1TermExecTab jj describe<CR>')
  vim.keymap.set('n', '<Plug>(jj)df<CR>', '<Cmd>1TermExecTab jj diff<CR>')
  vim.keymap.set('n', '<Plug>(jj)df-', '<Cmd>1TermExecTab jj diff --revision @-<CR>')
  vim.keymap.set('n', '<Plug>(jj)de', '<Cmd>1TermExecTab jj diffedit<CR>')
  vim.keymap.set('n', '<Plug>(jj)gf', '<Cmd>2TermExecBackground jj git fetch<CR>')
  vim.keymap.set('n', '<Plug>(jj)gp', '<Cmd>2TermExecVertical jj git push<CR>')
  vim.keymap.set('n', '<Plug>(jj)n', '<Cmd>2TermExecBackground jj new<CR>')
  ...
  vim.keymap.set('n', '<Plug>(jj)sq<CR>', '<Cmd>2TermExecBackground jj squash<CR>')
